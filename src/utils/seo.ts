...
export const getDynamicSEO = (
  ...
  if (pathname.includes('/category/') && pageData.category) {
    return {
      title: getTranslation(lang, "seo.pages.category.title").replace('{category}', pageData.category),
      description: getTranslation(lang, "seo.pages.category.description").replace('{category}', pageData.category)
    };
  }
  ...
  if (pageData.tool) {
    return {
      title: getTranslation(lang, "seo.pages.tool.title").replace('{tool}', pageData.tool),
      description: getTranslation(lang, "seo.pages.tool.description").replace('{tool}', pageData.tool)
    };
  }
